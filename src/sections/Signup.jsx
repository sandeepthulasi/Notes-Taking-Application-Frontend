  ...
  return (
    <motion.div
     ...
     exit={{x:window.innerWidth,transition:{duration:0.5}}}>
      <Navbar/>
      <Glass bgimg={"https://cdn.pixabay.com/photo/2017/04/19/13/15/computer-2242262_1280.jpg"}>
      <Text fontSize={"4xl"}>SignUp</Text>
        <Input width={"350px"} mt="10%" name="name" onChange={handleChange} placeholder="Add your name here" />
